 ...
 */
void Scene::Simulation(int Tps, const float &radius_sphere)
{
	...
	for(e=_enfants.begin(); e!=_enfants.end(); e++)
	{
		(*e)->Simulation(_g, _visco, Tps, radius_sphere);
	}
}
 ...
 */
void Scene::Collision(const float &radius_sphere)
{
