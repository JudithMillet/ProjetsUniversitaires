...
////////////////////////////////////////////////////////////////////////////////
template<class LCC>
void random_plane_intersection(LCC& lcc,
                               ...
                               std::size_t nb)
{
  ...
  Point pt1, pt2;
  typename LCC::Traits::Plane_3 p;
  for(std::size_t i=0; i<nb; ++i)
  {
    pt1=Point(random.get_double(xmin, xmax),
              random.get_double(ymin, ymax),
              random.get_double(zmin, zmax));
    pt2=Point(random.get_double(xmin-1, xmax+1),
              random.get_double(ymin-1, ymax+1),
              random.get_double(zmin-1, zmax+1));
    p=typename LCC::Traits::Plane_3(pt1, (pt1-pt2));
    Cut_by_plane<LCC>::cut(lcc, p);
  }
}
////////////////////////////////////////////////////////////////////////////////
template<class LCC>
void bbox_random_plane_intersection(LCC& lcc,
                                    double sx, double sy, double sz,
                                    std::size_t nb)
{
  make_hexa(lcc, typename LCC::Point(-1,-1,-1), sx+1, sy+1, sz+1);
  random_plane_intersection(lcc, 0, 0, 0, sx, sy, sz, nb);
}
////////////////////////////////////////////////////////////////////////////////
#endif
////////////////////////////////////////////////////////////////////////////////
